...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../tetris_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is tetris_soc
SOPC_NAME := tetris_soc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1a0
SOPC_SYSID_FLAG += --sidp=0x1a0
ELF_PATCH_FLAG  += --sidp 0x1a0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1637090941
SOPC_SYSID_FLAG += --timestamp=1637090941
ELF_PATCH_FLAG  += --timestamp 1637090941
